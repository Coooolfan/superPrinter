...
(
    ...
    paper_count  INT          NOT NULL DEFAULT 0 COMMENT '纸张数量',
...
(
    ...
    is_color        TINYINT(1)     NOT NULL DEFAULT 0 COMMENT '是否彩色打印：0-黑白，1-彩色',
    is_double_sided TINYINT(1)     NOT NULL DEFAULT 0 COMMENT '是否双面打印：0-单面，1-双面',
